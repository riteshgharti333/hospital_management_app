...
const ForgotPassword = () => {
  ...
  const onVerifyOtp = async (data) => {
    ...
    try {
      ...
      // Check if OTP is valid (in real app, this would be API call)
          ...
          <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8 text-center relative overflow-hidden">
            ...
            <div className="flex items-center justify-between relative z-10">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-blue-100 text-sm">MediCare Hospital Management</p>
              </div>
                ...
                <React.Fragment key={s.number}>
                  <div className="flex flex-col items-center">
                    <div className={`
                      ...
                      ${step === s.number ? 'ring-4 ring-blue-200 scale-110' : ''}
                    `}>
                  ...
                  {index < steps.length - 1 && (
                    <div className="flex-1 mx-4">
                      <div className="h-1 bg-gray-200 rounded-full overflow-hidden">
                        <motion.div
                          className={`h-full ${step > s.number ? 'bg-gradient-to-r from-blue-500 to-indigo-600' : 'bg-gray-300'}`}
                          initial={{ width: 0 }}
                      ...
                      <div>
                        ...
                        <div className="mt-4 text-center">
                          {countdown > 0 ? (
                            ...
                            >
                              <MdRefresh className={`w-4 h-4 ${loading ? 'animate-spin' : 'group-hover:rotate-180 transition-transform'}`} />
                        ...
                        <div className="relative group">
                          ...
                          <input
                            ...
                            {...registerReset('confirmPassword', {
                              ...
                              validate: value => 
                                value === watchReset('newPassword') || 'Passwords do not match'
                            })}
                            className={`
                              w-full pl-12 pr-4 py-3
                              bg-gray-50 border-2 rounded-xl
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <div className="flex flex-col items-center space-y-2">
                <p className="text-xs text-gray-400 text-center">
                  If you're having trouble resetting your password, please contact support
                </p>
                <a
